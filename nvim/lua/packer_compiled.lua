...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'indent-blankline.nvim', 'nvim-treesitter', 'nvim-colorizer.lua', 'null-ls.nvim', 'cinnamon.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
